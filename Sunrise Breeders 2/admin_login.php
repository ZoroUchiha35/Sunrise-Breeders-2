...
<head>
    ...
    <title>Admin Login - Sunrise Breeders</title>
    ...
    <style>
        * {
        ...
        /* Coffee bean decoration overlay */
        body::before {
            position: absolute;
            bottom: 20px;
            left: 20px;
        ...
        .brand-side {
            flex: 1;
            background: linear-gradient(rgba(34, 24, 16, 0.75), rgba(34, 24, 16, 0.85)), url('https://i.pinimg.com/1200x/55/a7/06/55a706bc2ca8221e1e0e4881be44ac5d.jpg');
            background-size: cover;
            background-position: center;
            padding: 2.5rem;
            display: flex;
        ...
        .divider::after {
            ...
            width: calc(50% - 60px);
            height: 1px;
            background: rgba(117, 117, 116, 0.8);
        }
...
<body>
    <div class="container">
        <div class="login-wrapper">
            <!-- Left Side - Branding with Full Background Image -->
            <div class="brand-side">
                <div class="brand-logo">
                    <h1>Sunrise Breeders</h1>
                    <div class="tagline">HANDCRAFTED COMFORT</div>
                </div>
                
                <div class="brand-message">
                    <h2>Welcome back, <span>Brewmaster</span></h2>
                    <p>Enter your credentials to access the administrative dashboard and manage your coffee sanctuary.</p>
                </div>
            ...
            <div class="form-side">
                <div class="form-header">
                    <div class="admin-badge">
                        <i class="fas fa-lock" style="margin-right: 4px;"></i> ADMIN ACCESS
                    </div>
                    <h3>Welcome back</h3>
                ...
                <form method="POST" action="">
                    <div class="input-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="username" placeholder="artisan@sunrise.com" 
                ...
                <div class="container" style="display: flex; justify-content: center;">
                    ...
                    <button class="Btn facebook" onclick="alert('Facebook login coming soon!')">
                        <svg
                        class="svgIcon"
                        viewBox="0 0 24 24"
                        height="1.5em"
                ...
                <div class="register-link">
                    Admin Page <a href="login.php">Back to Customer Login</a>
                </div>
            </div>
        </div>
    </div>
